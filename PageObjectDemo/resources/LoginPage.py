...
class LoginPage(PageObject):
    ...
    def _is_current_page(self):
        ...
        # of this function. Instead, we'll check the page location, and raise an appropriate error if we are not on the correct page
    ...
    def click_the_login_button(self):
        ...
        # For illustrative purposes, this uses the low level selenium functions for submitting the form

        form = self.driver.find_element_by_xpath("//form[@id='%s']" % self.locator.form_id)

        # since this action causes the page to be refreshed, wrap this in a context manager so it does't return until the new page is rendered
