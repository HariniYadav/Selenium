...
Enter the values in ID creation page
    ...
    Log    Entering Data for Creation of Apple ID Process is Successful
    sleep   2
...
Locations Test
    ...
    @{currentBrowserstitles}=    Get Window Titles   browser=Browser1
    FOR     ${i}    IN  @{currentBrowserstitles}
       LOG  ${i}
    END
