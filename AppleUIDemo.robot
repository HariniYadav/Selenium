...
Enter the values in ID creation page
    ...
    input text  xpath://div[contains(@class,'field-wrapper padding right')]//first-name-input//div[contains(@class,'name-input')]//idms-textbox//idms-error-wrapper//div//input[contains(@class,'')]  ${firstname}
    input text  xpath://div[contains(@class,'field-wrapper padding left')]//last-name-input//div[contains(@class,'name-input')]//idms-textbox//idms-error-wrapper//div//input[contains(@class,'')]    ${lastname}
